        ...
        <div>
            <Dialog open={isOpen} onClose={handleClose} aria-labelledby="form-dialog-title" fullWidth={true} maxWidth={"lg"}>
                <DialogContent>
                    ...
                    <p className="TextCursiv">Для использования функции «Подпись файлов в браузере» Вам необходимо подготовить рабочее место. Для подготовки рабочего места желательно обратитесь к IT специалистам</p>
                    ...
                    <Spoller caption="Подготовка рабочего места">
                        ...
                        <Spoller caption="Обновление списков отзывов при отсутсвии сети Интернет">
                            ...
                            <p>
                                Например, адрес точки распространения CRL для центра сертификации ФФОМС: http://<span className="BoldText">ucfoms.ffoms.ru</span>/cdp/630a8f435386a2e3f3e340c9adb5640bd9640dce.crl, данный файл вы можете найти на http://<span className="BoldText">mis.zabtfoms.ru</span>/cdp/630a8f435386a2e3f3e340c9adb5640bd9640dce.crl
                            </p>
                            <p>
                    ...
                    <Spoller caption="Использование функций модуля">
                        ...
                        <Spoller caption="Действия над файлами">
                            ...
                            <Spoller caption="Подпись документа путем загрузки открепленной подписи">
                                ...
                                <p>Для подписи документа путем загрузки открепленной подписи нажмите на кнопку «Загрузить открепленную подпись», после чего откроется следующие окно:</p>
