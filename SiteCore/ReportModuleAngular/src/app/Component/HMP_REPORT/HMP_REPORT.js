...
let HmpReportComponent = class HmpReportComponent extends BaseReportComponent {
    constructor(repo) {
        super();
        this.repo = repo;
        this.report = [];
...
HmpReportComponent = __decorate([
    Component({ selector: "hmp-report", templateUrl: "HMP_REPORT.html" })
], HmpReportComponent);
export { HmpReportComponent };
//# sourceMappingURL=HMP_REPORT.js.map